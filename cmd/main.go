...
func main() {
	...
	urls.Add(scrappertweets.NewQueryURL("JeniusConnect", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("bankmandiri", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("linkaja", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("kontakBRI", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("ovo_id", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("BNI", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("HaloBCA", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("danawallet", "Whatsapp|Mohon Maaf", "is:reply"))
	urls.Add(scrappertweets.NewQueryURL("gopayindonesia", "Whatsapp|Mohon Maaf", "is:reply"))
